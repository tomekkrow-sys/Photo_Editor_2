# Instrukcje tworzenia release'u v0.2.2

## Przygotowanie do release'u

1. Sprawdź aktualne tagi w repozytorium:
```bash
git tag -l
```
...
## Tworzenie release'u przez GitHub CLI
...
## Alternatywnie - tworzenie release'u przez interfejs GitHub

1. Wejdź na stronę projektu na GitHubie
2. Kliknij "Releases" w lewym panelu
3. Kliknij "Draft a new release"
4. W polu "Tag version" wpisz: `v0.2.2`
5. W polu "Release title" wpisz: `Version 0.2.2`
6. W pole "Describe this release" wklej treść z pliku RELEASE_NOTES_v0.2.2.md
7. Dodaj niezbędne pliki binarne (jeśli są)
8. Kliknij "Publish release"

## Zawartość pliku RELEASE_NOTES_v0.2.2.md:
