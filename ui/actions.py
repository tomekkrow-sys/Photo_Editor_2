...
class ActionManager:
    ...
    def _create_actions(self):
        ...
        self.gaussian_blur = QAction("Rozmycie Gaussa", self.parent)
        self.sharpen = QAction("Ostrzenie", self.parent)
        self.emboss = QAction("Wydrążenie", self.parent)
        ...
        self.hdr = QAction("HDR", self.parent)
        self.cartoon = QAction("Cartoon", self.parent)
        self.glitch = QAction("Glitch Art", self.parent)
        self.thermal = QAction("Termowizja", self.parent)
        self.pixelate = QAction("Pikseloza", self.parent)
        self.duotone = QAction("Duotone", self.parent)
        self.theme_toggle = QAction("Zmotyw ciemny/jasny", self.parent)
        self.lang_pl = QAction("Polski", self.parent)
        self.lang_en = QAction("English", self.parent)
        self.lang_es = QAction("Espanol", self.parent)
        self.shortcuts = QAction("Skróty klawiszowe...", self.parent)
        self.layers = QAction("Warstwy...", self.parent)
        self.face_detect = QAction("Rozpoznawanie twarzy", self.parent)
        self.history_timeline = QAction("Historia edycji", self.parent)
