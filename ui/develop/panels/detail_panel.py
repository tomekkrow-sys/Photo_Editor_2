#!/usr/bin/env python3
"""Photo Editor 2.0 — Detail / Sharpening Panel."""
...
class DetailPanel(QWidget):
    """Detail controls: Sharpness, Clarity, Noise Reduction."""
    ...
    def __init__(self, parent=None) -> None:
        ...
        for name, label in [
            ("sharpness", "Ostrosc"),
            ("clarity", "Klarownosc"),
            ("noise_reduction", "Redukcja szumu"),
        ]:
        ...
        reset_btn = QPushButton("Resetuj szczegoly")
