#!/usr/bin/env python3
"""Photo Editor 2.0 — Basic Adjustments Panel."""
...
class _SliderRow(QWidget):
    """Single labeled slider with value display."""
...
class BasicPanel(QWidget):
    """
    Basic tone adjustments: Exposure, Contrast, Highlights,
    ...
    def __init__(self, parent=None) -> None:
        ...
        reset_btn = QPushButton("Resetuj podstawowe")
